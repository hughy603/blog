...
ROOT_DIR = environ.Path(__file__) - 3  # (blog/config/settings/common.py - 3 = blog/)
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'blog.contrib.sites.migrations'
}
...
########## CELERY
INSTALLED_APPS += ('blog.taskapp.celery.CeleryConfig',)
